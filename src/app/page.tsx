...
export default function LandingPage() {
      ...
      avatars={[
        {
          ...
          alt: "Confident model with pink bob hairstyle flaunts bold attitude",
        },
        {
          src: "http://img.b2bpic.net/free-photo/high-angle-unknown-woman-posing_23-2149417557.jpg",
          alt: "High angle unknown woman posing",
        },
        {
          src: "http://img.b2bpic.net/free-photo/woman-portrait-with-bright-blue-lips_23-2151096450.jpg",
        ...
        },
        {
          ...
          alt: "Outdoor shot of pensive curly haired woman",
        },
      ]}
      ...
      metrics={[
        {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/happy-young-adult-male-using-smartphone-night-cityscape_53876-14743.jpg",
        },
        {
          id: "m2",
          value: "12.5k+",
          title: "Happy Clients",
          description: "Reliably served Northampton since day one.",
        ...
        },
        {
          ...
          value: "100%",
          title: "Quality Parts",
          description: "No cheap knockoffs used here.",
          imageSrc: "http://img.b2bpic.net/free-photo/close-up-hands-making-shoes_23-2149007460.jpg",
        },
      ]}
      title="Our Impact"
      ...
      testimonials={[
        {
          ...
          name: "James Fallon",
          handle: "@jamesf",
          testimonial: "30 mins fix, brilliant service.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Ali Idris",
          handle: "@aliidris",
          testimonial: "Virus fixed, best shop in town.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Salman Ahmed",
          handle: "@salmana",
          testimonial: "MacBook Air M1 repair was exceptional.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Anna Napalasi",
          handle: "@annanap",
          testimonial: "Customer service beyond the charts.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Sami Circeie",
          handle: "@samic",
          testimonial: "Trusted them for years, never failed.",
          rating: 5,
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "f1",
          title: "How fast is your repair service?",
          content: "Most screen and battery replacements are completed in under 30 minutes while you wait.",
        },
        {
          id: "f2",
          title: "Do you provide warranties?",
          content: "Yes, all our repairs and pre-owned device sales include a 12-month quality guarantee.",
        },
        {
          id: "f3",
          title: "What devices do you fix?",
          content: "We handle most iPhone and Android smartphones, as well as MacBook and Windows laptops.",
        },
      ]}
